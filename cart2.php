					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								<tr class="table_head">
									<th class="column-1">e</th>
									<th class="column-2">Naam</th>
									<th class="column-3">Prijs</th>
									<th class="column-4">Aantal</th>
									<th class="column-5">Totaal</th>
								</tr>
								<?php 
								$total=0;
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="">
											...
											<button class="btn btn-sm btn-outline-danger" name="remove">Verwijderen</button>
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="payment">
											...
											<option value="paypal">Ideal</option>
										</select>
